...
class AuthController extends Controller
{
    ...
    public function login_attempt(LoginRequest $request): RedirectResponse
    {
        try {
            ...
            if (Auth::attempt($credentials, $remember)) {
                ...
                $user = Auth::user();
                $hasRole = $user->roles->contains('code', 'parent');
                Auth::logout();
    ...
    public function forgot_password_attempt(Request $request)
    {
        ...
        try {
            ...
            $user->notify(new ParentResetPassword($token, $user));
    ...
    {
        return view('parent.auth.reset', ['token' => $token]);
    }
