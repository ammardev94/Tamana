...
class AuthController extends Controller
{
    public function login(Request $request)
    {
        ...
        return view('student.auth.index');
    }
    ...
    public function login_attempt(LoginRequest $request): RedirectResponse
    {
        try {
            ...
            if (Auth::attempt($credentials, $remember)) {
                ...
                $user = Auth::user();
                $hasRole = $user->roles->contains('code', 'student');
                Auth::logout();
    ...
    public function forgot_password_attempt(Request $request)
    {
        ...
        try {
            ...
            $user->notify(new StudentResetPassword($token, $user));
    ...
    {
        return view('student.auth.reset', ['token' => $token]);
    }
