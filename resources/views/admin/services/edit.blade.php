...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.services.update', $service->id) }}" method="POST" id="editService" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="form-label" for="img">Service Image</label>
                                <input type="file" class="form-control" name="img" id="img">
                                <img src="{{ $service->img ? asset('storage/' . $service->img) : '' }}"
                                    alt="" style="max-width: 100%; height: 200px; {{ $service->img ? '' : 'display:none;' }}">
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $("#editService").validate({
        rules: {
            ...
            link: { url: true },
            img: { extension: ['jpg', 'jpeg', 'png'] }
        },
        messages: {
            title: { required: "Please enter a title" },
            description: { required: "Please enter description" },
            img: { extension: 'Only jpg, jpeg, png allowed' }
        },
        errorElement: "label",
        validClass: "is-valid",
