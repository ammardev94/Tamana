    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Add New Page Meta</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{ route('cms.page_meta.store') }}" method="POST" id="addPageMetaForm">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ref_key" id="ref_key" placeholder="Enter title">
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label for="ref_value">Reference Value</label>
                                <input type="text" class="form-control" name="ref_value" id="slug" placeholder="Enter slug">
                            </div>
                        </div>
                    </div>
                </div>
