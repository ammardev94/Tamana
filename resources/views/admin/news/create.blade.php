                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="author_name" id="author_name" placeholder="Enter author name" value="{{ old('author_name') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="author_youtube" id="author_youtube" value="{{ old('author_youtube') }}" placeholder="http://">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="author_facebook" id="author_facebook" value="{{ old('author_facebook') }}" placeholder="http://">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="author_linkdin" id="author_linkdin" value="{{ old('author_linkdin') }}" placeholder="http://">
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $("#addNews").validate({
        rules: {
            ...
            author_img: { required: true, extension: ['jpg', 'jpeg', 'png'] }
        },
        messages: {
            ...
            author_img: { required: 'Please upload author image', extension: 'Only jpg, jpeg, png allowed' }
        },
        errorElement: "label",
        validClass: "is-valid",
