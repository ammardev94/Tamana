    ...
    <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active">Add SEO Page</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form action="{{ route('admin.seo_pages.store') }}" method="POST" id="addSeoPage">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <select name="indexing" id="indexing" class="form-control">
                                    ...
                                    <option value="follow_index" {{ old('indexing') == 'follow_index' ? 'selected' : '' }}>follow,index</option>
                                    <option value="nofollow_noindex" {{ old('indexing') == 'nofollow_noindex' ? 'selected' : '' }}>nofollow,noindex</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="canonical" id="canonical" placeholder="http://" value="{{ old('canonical') }}">
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $("#addSeoPage").validate({
        rules: {
            ...
            canonical: { required: true, url: true }
        },
        messages: {
            ...
            canonical: { required: "Please enter canonical URL", url: "Enter a valid URL" }
        },
        errorElement: "label",
        validClass: "is-valid",
