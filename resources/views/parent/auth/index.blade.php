        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="d-lg-flex align-items-center justify-content-center bg-light-300 d-lg-block d-none flex-wrap vh-100 overflowy-auto bg-01">
                    <div>
                        <img src="{{ asset('assets/img/authentication/authentication-06.svg') }}" alt="Img">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
                    <div class="col-md-8 mx-auto p-4">
                        <form action="{{ route('parent.login.attempt') }}" method="POST">
                            @csrf
                            <div>
                                ...
                                <div class="card">
                                    <div class="card-body p-4">
                                            ...
                                            <div
                                                ...
                                                <div class="text-center flex-fill">
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <img class="img-fluid  m-1"
                                                            src="{{ asset('assets/img/icons/apple-logo.svg') }}" alt="Apple"
                                                        />
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-wrap form-wrap-checkbox mb-3">
                                            ...
                                            <div class="text-end ">
                                                <a href="{{ route('parent.forgot.password') }}" class="link-danger">Forgot
                                                    Password?</a>
                                            </div>
                                        </div>
                                        <div class="mb-3">
