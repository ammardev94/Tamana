...
<div class="row">
    <div class="col-md-2 border-0">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('parent.profile.update') }}" method="POST" id="imgForm" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-md-10 border-0">
        ...
        <div class="card">
            <form action="{{ route('parent.profile.update') }}" method="POST" id="personalInfoForm" enctype="multipart/form-data">
                @csrf
                @method('PUT')
