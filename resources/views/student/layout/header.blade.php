<div class="header">
                ...
                <div class="pe-1" id="notification_item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="{{ route('student.notification.mark-all-read') }}" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
                            </div>
                        </div>
                        ...
                        <div class="d-flex p-0">
                            ...
                            <a href="{{ route('student.notification.index') }}" class="btn btn-primary w-100">View All</a>
                        </div>
                    </div>
                </div>
                <div class="pe-1">
                ...
                <div class="dropdown ms-1">
                    <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
                        ...
                        <span class="avatar avatar-md rounded">
                            <img src="{{ asset('storage/' . (optional(auth()->guard('student')->user()->profile)->img ?? 'profile/default.jpg')) }}" alt="Img" class="img-fluid">
                        </span>
                    </a>
                        ...
                        <div class="d-block">
                            <div class="d-flex align-items-center p-2">
                                <span class="avatar avatar-md me-2 online avatar-rounded">
                                    <img src="{{ asset('storage/' . (optional(auth()->guard('student')->user()->profile)->img ?? 'profile/default.jpg')) }}" alt="img">
                                </span>
                                <div>
                            ...
                            <hr class="m-0">
                            <a class="dropdown-item d-inline-flex align-items-center p-2" href="{{ route('student.profile.index') }}">
    ...
    <form style="display: none;" action="{{ route('student.logout') }}" method="POST" id="logout-form">
        @csrf
