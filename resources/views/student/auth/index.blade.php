            ...
            <div class="col-lg-6">
                <div class="login-background position-relative d-lg-flex align-items-center justify-content-center d-lg-block d-none flex-wrap vh-100 overflowy-auto">
                    ...
                    <div class="authen-overlay-item  w-100 p-4">
                        <h4 class="text-white mb-3">What's New on {{ config('app.name') }} !!!</h4>
                        <div
                            ...
                            <div>
                                ...
                                <div class="card">
                                    <div class="card-body p-4">
                                        <div class=" mb-4">
                                            <h2 class="mb-2">Student Login</h2>
                                            ...
                                            <div
                                                ...
                                                <div class="text-center me-2 flex-fill">
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <img class="img-fluid m-1"
                                                            src="{{ asset('assets/img/icons/facebook-logo.svg') }}"
                                                            alt="Facebook"
                                                        />
                                                    </a>
                                                </div>
                                                <div class="text-center me-2 flex-fill">
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <img class="img-fluid  m-1"
                                                            src="{{ asset('assets/img/icons/google-logo.svg') }}"
                                                            alt="Facebook"
                                                        />
                                                    </a>
                                                </div>
                                                <div class="text-center flex-fill">
                                                    <a href="javascript:void(0);"
                                                        ...
                                                        <img class="img-fluid  m-1"
                                                            src="{{ asset('assets/img/icons/apple-logo.svg') }}" 
                                                            alt="Apple"
                                                        />
                                                    </a>
                                                </div>
                                        ...
                                        <div class="form-wrap form-wrap-checkbox mb-3">
                                            ...
                                            <div class="text-end ">
                                                <a href="{{ route('student.forgot.password') }}" class="link-danger">Forgot
                                                    Password?</a>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="text-center">
                                            <h6 class="fw-normal text-dark mb-0">Don’t have an account? <a
                                                    href="javascript:void(0);" class="hover-a "> Create Account</a>
                                            </h6>
                                        </div>
                                    </div>
                                </div>
