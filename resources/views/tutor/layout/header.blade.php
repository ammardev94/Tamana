<div class="header">
    ...
    <div class="header-left active">
        <a href="{{ route('tutor.dashboard') }}" class="logo logo-normal">
            <img src="{{ asset('images/logo.png') }}" alt="Logo">
        </a>
        <a href="{{ route('tutor.dashboard') }}" class="logo-small">
            <img src="{{ asset('images/logo.png') }}" alt="Logo">
        </a>
        <a href="{{ route('tutor.dashboard') }}" class="dark-logo">
            <img src="{{ asset('images/logo.png') }}" alt="Logo">
        </a>
                ...
                <div class="pe-1" id="notification_item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end notification-dropdown p-4">
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <a href="{{ route('tutor.notification.mark-all-read') }}" class="text-primary fs-15 me-3 lh-1">Mark all as read</a>
                            </div>
                        </div>
                                ...
                                @isset($unreadNotifications)
                                    @foreach ($unreadNotifications as $notification)
                                        <div class="border-bottom mb-3 pb-3">
                                            <a href="{{ route('tutor.application.show', [$notification->data['application_id']]) }}">
                                                <div class="d-flex">
                        ...
                        <div class="d-flex p-0">
                            ...
                            <a href="{{ route('tutor.notification.index') }}" class="btn btn-primary w-100">View All</a>
                        </div>
                    </div>
                </div>
                <div class="pe-1">
                ...
                <div class="dropdown ms-1">
                    <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
                        ...
                        <span class="avatar avatar-md rounded">
                            <img src="{{ asset('storage/' . (optional(auth()->guard('tutor')->user()->profile)->img ?? 'profile/default.jpg')) }}" alt="Img" class="img-fluid">
                        </span>
                    </a>
                        ...
                        <div class="d-block">
                            <div class="d-flex align-items-center p-2">
                                <span class="avatar avatar-md me-2 online avatar-rounded">
                                    <img src="{{ asset('storage/' . (optional(auth()->guard('tutor')->user()->profile)->img ?? 'profile/default.jpg')) }}" alt="img">
                                </span>
                                <div>
                                    <h6>{{ auth()->guard('tutor')->user()->name }}</h6>
                                </div>
                            </div>
                            <hr class="m-0">
                            <a class="dropdown-item d-inline-flex align-items-center p-2" href="{{ route('tutor.profile.index') }}">
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item" href="{{ route('tutor.profile.index') }}">My Profile</a>
            <a class="dropdown-item" href="javascript:void(0);" onclick="logout()">Logout</a>
        </div>
    </div>
    <!-- /Mobile Menu -->

    <form style="display: none;" action="{{ route('tutor.logout') }}" method="POST" id="logout-form">
        @csrf
