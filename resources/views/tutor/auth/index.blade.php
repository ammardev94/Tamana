@extends('tutor.auth.default')

@section('content')

<div class="row justify-content-center">
    <div class="col-md-5 mx-auto">
        <form action="{{ route('tutor.login.attempt') }}" method="POST">
            @csrf
                ...
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <div class="form-wrap form-wrap-checkbox mb-3">
                            ...
                            <div class="text-end">
                                <a href="{{ route('tutor.forgot.password') }}" class="link-danger">Forgot Password?</a>
                            </div>
                        </div>
                        <div class="mb-3">
